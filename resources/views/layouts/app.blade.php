...
<header class="w-full" id="main-header">
    ...
    <div class="max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div class="flex-1">
                <a href="/">
                    <img src="{{ asset('images/logo-seo.jpeg') }}" alt="allbirds" class="h-8 w-auto">
                </a>
            </div>
    ...
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
        <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                ...
                <a href={{ route('register') }}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"></path></svg></a>
