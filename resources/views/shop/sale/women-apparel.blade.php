...
<div class="bg-[#f5f2ed] min-h-screen">
    ...
    <section class="relative w-full h-[50vh] md:h-[60vh] bg-cover bg-center rounded-2xl" 
             style="background-image: url('/images/sale-apparel-hero-women.webp');"> {{-- Updated Image Path --}}
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center bg-[#E5DFD6] border border-[#D4CDC3] rounded-full p-[4px]">
                <a href="{{ url('/sale/men/apparel') }}"
                   class="px-6 py-1.5 rounded-full text-[13px] font-medium transition text-black"> {{-- Inactive style --}}
                    MEN
                </a>
                <a href="{{ url('/sale/women/apparel') }}"
                   class="px-6 py-1.5 rounded-full text-[13px] font-medium transition bg-black text-white"> {{-- Active style --}}
                    WOMEN
                </a>
            </div>

            {{-- Sort Dropdown (Keep as is) --}}
    ...
    <section class="max-w-full px-4 py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6">
        ...
        <div class="col-span-full text-center py-20">
            <p class="text-gray-500 text-lg">No women's apparel on sale at the moment.</p>
