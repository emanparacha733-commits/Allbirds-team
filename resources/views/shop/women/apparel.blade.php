...
<section class="relative w-full h-[30vh] md:h-[60vh] bg-cover bg-center rounded-2xl" style="background-image: url('/images/women.webp');">
    <!-- Overlay -->
    ...
    <div class="relative z-10 max-w-7xl mx-auto h-full flex flex-col justify-between md:px-8 text-white">
        ...
        <!-- Top Links -->
        <div class="flex gap-4 text-sm tracking-wide mt-12 font-seri font-normal">
            <a href="#" class="hover:underline">Home/</a>
            <a href="#" class="hover:underline">Women/</a>
            <a href="#" class="hover:underline">Women's Apparel  Collection</a>
        </div>

        <!-- Heading near bottom -->
        <p class="max-w-xl text-3xl  md:text-2xl font-medium leading-tight lg:mb-8 mb-4 md:mb-16 sm:text-sm font-serif">
...
<div class="w-full max-w-6xl mx-auto px-6 py-4 flex items-center justify-between bg-[#E6DDD0] rounded-[40px] mt-4">
  ...
  <div class="flex items-center gap-4">
    ...
    <a href="{{ url('/men') }}"
       ...
       {{ request()->is('men') ? 'bg-black text-white' : 'text-black' }}">
       MEN
    </a>

    <a href="{{ url('/women') }}"
       class="px-6 py-1.5 rounded-full text-[13px] font-medium transition
       {{ request()->is('women') ? 'bg-black text-white' : 'text-black' }}">
       WOMEN
    </a>
 ...
 <div class="relative inline-block">
  ...
  <!-- Button -->
  <button id="sortBtn"
    class="flex items-center gap-2 px-6 py-2 bg-[#E5DFD6] border border-[#D4CDC3] rounded-full text-[13px] font-medium text-black hover:opacity-80 cursor-pointer hover:bg-black hover:text-white 
...
<div class="relative h-[520px] w-[270px]">
  ...
  <div
    ...
    <!-- Image -->
    <img src="images/sho6.png" class="w-full h-48 object-cover rounded-xl" />
...
<div class="relative rounded-2xl overflow-hidden shadow-lg w-full mx-auto cursor-pointer group">
  ...
  <img src="images/first.webp" alt="Shoes"
       class="w-full h-[400px] sm:h-[300px] md:h-[350px] lg:h-[400px] object-cover rounded-2xl
...
<div class="relative rounded-2xl overflow-hidden shadow-lg w-full mx-auto cursor-pointer group">
  ...
  <img src="images/second.webp" alt="Apparel"
       class="w-full h-[400px] sm:h-[300px] md:h-[350px] lg:h-[400px] object-cover rounded-2xl
              transition-transform duration-1000 ease-out
              group-hover:scale-105" />
...
<div class="relative rounded-2xl overflow-hidden shadow-lg w-full mx-auto cursor-pointer group">
  ...
  <img src="images/third.webp" alt="Accessories"
       class="w-full h-[400px] sm:h-[300px] md:h-[350px] lg:h-[400px] object-cover rounded-2xl
              transition-transform duration-1000 ease-out
              group-hover:scale-105" />
