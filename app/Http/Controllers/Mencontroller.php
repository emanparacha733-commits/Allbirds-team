...
class MenController extends Controller
{
    ...
    public function apparel(Request $request)
    {
        ...
        $query = Product::whereIn('gender', ['men', 'unisex'])->where('type', 'apparel');
    ...
    public function apparelCategory(Request $request, $category)
    {
        ...
        return view('shop.men.detailsocks', compact('product', 'category')); // ✅ FIXED
    }
    ...
    {
        $sort = $request->get('sort', 'featured');
        $query = Product::whereIn('gender', ['men', 'unisex'])->where('type', 'socks');
        $query = $this->applySorting($query, $sort);
        $products = $query->get();
    ...
    {
        $sort = $request->get('sort', 'featured');
        $query = Product::whereIn('gender', ['men', 'unisex'])
                        ->where('type', 'socks')
